...
public class FloatingBoat : MonoBehaviour
{
    ...
    public Vector3 smoothedPosition; // Smoothed position for floating motion
    ...
    public void Start()
    {
        targetSurface = GameObject.FindGameObjectWithTag("Water").GetComponent<WaterSurface>();
    }
    void LateUpdate()
    {
